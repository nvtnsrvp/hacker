...
def calculate_p_no_zombie_can_reach_yard_i(p_zombie_j_cannot_reach_yard_i):
    return np.prod(p_zombie_j_cannot_reach_yard_i, axis=0)
...
def at_least_one_yard_is_safe(fences, zombies):
    ...
    # print(p_no_zombie_can_reach_yard_i)
    ...
    # print(p_at_least_one_yard_is_safe)
    return int(np.round(p_at_least_one_yard_is_safe * 1000000007))
